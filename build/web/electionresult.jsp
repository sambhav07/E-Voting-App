...
<%
    ...
    LinkedHashMap<String,Integer> genderResult=(LinkedHashMap)request.getAttribute("gresult");
    System.out.println("size 1 : "+resultDetails.size());
    int votecount=(int)request.getAttribute("votecount");
    System.out.println("total vote : "+votecount);
    Iterator it=resultDetails.entrySet().iterator();
    StringBuffer displayBlock=new StringBuffer("<table>");
    displayBlock.append("<tr><th>Candidate Id</th><th>Candidate Name</th><th>Party</th><th>Symbol</th><th>City</th><th>Vote Count</th><th>Vote Percent</th></tr>");
    while(it.hasNext())
    {
    ...
    displayBlock.append("<div><table>");
    displayBlock.append("<tr><th></th><th>Voting Percentage</th></tr>");
    it=genderResult.entrySet().iterator();
    while(it.hasNext())
    {
        Map.Entry<String,Integer> e=(Map.Entry)it.next();
        displayBlock.append("<tr><td>"+e.getKey()+"</td><td>"+(e.getValue()*100.0f)/votecount+"</td></tr>");
    }
